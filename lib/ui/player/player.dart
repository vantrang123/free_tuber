...
class _PlayerScreenState extends State<PlayerScreen> {
  ...
  @override
  void dispose() {
    _audioManager?.currentVideo?.lastDuration = _videoPlayerController?.value.position;
  ...
  void init() {
    ...
    _audioManager?.pause();
    _videoControlProvider = Provider.of<VideoControlProvider>(context, listen: false);
                ...
                if (_playerStore?.playerController?.value.isInitialized != true)
                  AspectRatio(
                    ...
                    child: Stack(
                      children: [
                        Thumbnail(
                            ratio: 16 / 9, url: widget.video.thumbnailUrl ?? ""),
                        Container(
  ...
  void videoListener() {
    ...
    VideoDurationChange durationChange = Provider.of<VideoDurationChange>(context, listen: false);
