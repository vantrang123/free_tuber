...
import 'package:free_tuber/stores/video/video_channel_store.dart';
...
class MyApp extends StatelessWidget {
  ...
  final VideoChannelStore _videoChannelStore = VideoChannelStore(getIt<VideoRepository>());
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        Provider<VideoChannelStore>(create: (_) =>_videoChannelStore),
